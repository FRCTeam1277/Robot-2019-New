...
public class Dashboard {
    public static void refresh() {
        ...
        SmartDashboard.putBoolean("UP", GrabHatch.direction);
        SmartDashboard.putNumber("Encoder until vertical", 250-RobotMap.hatchEncoder.getDistance()%250);
        SmartDashboard.putBoolean("Done Releasing", RobotMap.releaseLimit.get());
    }
}
