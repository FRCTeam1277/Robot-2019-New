...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		new Thread(() -> {
			...
			CvSource outputStream = CameraServer.getInstance().putVideo("Stream", 160, 120);
		...
		// HttpCamera piCam = new HttpCamera("piCam",
		// "http://10.12.77.10:1181/stream.mjpg", HttpCameraKind.kMJPGStreamer);

		// CvSink cvSink2 = CameraServer.getInstance().getVideo(piCam);
		// CvSource outputStream = CameraServer.getInstance().putVideo("Pi Cam", 1280,
		// 720);
